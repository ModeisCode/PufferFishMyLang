...
_lr_productions = [
  ...
  ('expression -> expression PLUS term','expression',3,'p_expression_plus','mathlex.py',34),
  ('expression -> expression MINUS term','expression',3,'p_expression_minus','mathlex.py',38),
  ('expression -> term','expression',1,'p_expression_term','mathlex.py',42),
  ('term -> term TIMES factor','term',3,'p_term_times','mathlex.py',46),
  ('term -> term DIVIDE factor','term',3,'p_term_div','mathlex.py',50),
  ('term -> factor','term',1,'p_term_factor','mathlex.py',54),
  ('factor -> NUMBER','factor',1,'p_factor_num','mathlex.py',58),
  ('factor -> LPAREN expression RPAREN','factor',3,'p_factor_group','mathlex.py',62),
  ('factor -> MINUS factor','factor',2,'p_factor_uminus','mathlex.py',66),
]
